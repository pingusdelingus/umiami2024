...
public class LibraryTest {
  ...
  public static void main(String[] args) {
	    ...
	    lib.add(9783374292799L, "Ishmael shimshemllawitz", "the art of thinking");
	    ...
	    lib.checkout(9783374292799L, "Ishmael shimshemllawitz", 1,1,2009);
	    
	    if(lib.checkin(9783374292799L) == false) {
	    	System.out.println("The test worked");
	    }else {
	    	System.out.println("the test output is TRUE");
	    }
